...
try:
    ...
    print('\n \033[1;91m[\033[1;93mABUSAIM-143\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mABUSAIM-143\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mABUSAIM-143\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "update" in srv:
        ...
        for j in range(3000):
            time.sleep(0.5)
            os.system('xdg-open https://facebook.com/groups/sbhalpinghackrteam/')
...
def logo():
    os.system('clear')
    print(f
888    888     d8888  Y88b   d88P 
888    888    d8P888   Y88b d88P  
888    888   d8P 888    Y88o88P   
8888888888  d8P  888     Y888P    
888    888 d88   888     d888b    
888    888 8888888888   d88888b   
